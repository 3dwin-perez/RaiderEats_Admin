...
import 'package:raidereats_admin_website_portal/widgets/simple_app_bar.dart';
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        "Total Earnings".toUpperCase() + "\$" + allSellers!.docs[i].get("earning").toString(),
                        style: const TextStyle(
                          fontSize: 15,
                          color: Colors.white,
                          letterSpacing: 3,
                      ...
                      onPressed: ()
                      {
                        SnackBar snackBar =  SnackBar(
                          content: Text(
                            "Total Earnings".toUpperCase() + "\$" + allSellers!.docs[i].get("earning"),
                            style: const TextStyle(
                              fontSize: 36,
                              color: Colors.black,
                            ),
